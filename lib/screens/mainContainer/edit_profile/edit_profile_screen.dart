                ...
                icon: Row(
                  children: [
                    ...
                    CustomText(
                      ...
                      style: CustomTextStyle()
                          .semibold(size: 14, color: const Color(0xff419aff)),
                    )
                  ],
                )),
          )
        ...
        child: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> streamSnapshot) {
              if (streamSnapshot.hasData) {
                ...
                _bloc.dateOfBirthController.text =
                    documentSnapshot["Date Of Birth"];
                ...
                _bloc.usedLanguageValue.value =
                    documentSnapshot["Used language with the client at home"];
                _bloc.mobileNumberController.text =
                    documentSnapshot["Mobile Number"];
                _bloc.parentOcupationValue.value =
                    documentSnapshot["Parents occupation"];
                _bloc.hisrankController.text =
                    documentSnapshot["siblings and his rank"];
                _bloc.kinshipValue.value =
                    documentSnapshot["Is there any kinship between parents?"];
                _bloc.foundCountactValue.value =
                    documentSnapshot["You found contact us via"];
                _bloc.whatIsYourComplaintBriefly =
                    documentSnapshot["What is your complaint? briefly"];
                _bloc.whenTheProblemWasFirstNoted =
                    documentSnapshot["When the problem was first noted?"];
                ...
                _bloc.hasYourChildBeenDiagnosedWithAnyOfThese =
                    documentSnapshot[
                        "Has your child been diagnosed with any of these?"];
                ...
                _bloc.hadYourChildEnrolledPreviouslyInAnyRehabilitationPrograms =
                    documentSnapshot[
                ...
                _bloc.firstEvaluationDate =
                    documentSnapshot["1 st Evaluation Date"];
                _bloc.firstTherapeuticSessionDate =
                    documentSnapshot["1 st Therapeutic Session Date"];
                ...
                _bloc.hasYourChildExperiencedAnyOfThese = documentSnapshot[
                    "Has your child experienced any of these?"];
                ...
                _bloc.didYourChildDelayInAnyOfTheseDevelopmentalStages =
                    documentSnapshot[
                        "Did your child delay in any of these developmental stages?"];
                _bloc.checkTheSkillsThatYourChildAchievesIndependently =
                    documentSnapshot[
                        "Check the skills, that your child achieves independently"];
                _bloc.howDoesYourChildCommunicateMostOfTheTime =
                    documentSnapshot[
                        "How does your child communicate, most of the time?"];
                _bloc.recentlyYourChildsSpeechIs =
                    documentSnapshot["Recently, your child’s speech is"];
                _bloc.whenYourChildDidProduceHisFirstWord = documentSnapshot[
                    "When your child did produce his first word?"];
                _bloc.doesTheChildUseAnyUtterancesInHisSpeechGiveExample =
                    documentSnapshot[
                        "Does the child use any utterances in his speech? Give example"];
                _bloc.describeYourChildReceptiveLanguage = documentSnapshot[
                    "Describe your child’s receptive language"];
                _bloc.describeYourChildExpressiveLanguage = documentSnapshot[
                    "Describe your child’s expressive language"];
                _bloc.describeYourChildBehavior =
                    documentSnapshot["Describe your child’s behavior"];
                _bloc.describeYourChildFocusAndAttention = documentSnapshot[
                    "Describe your child’s focus and attention"];
                ...
                _bloc.howMuchTimeYourChildSpendsOnTVSmartDevices =
                    documentSnapshot[
                        "How much time your child spends on TV smart devices?"];
                ...
                return Column(
                  children: [
                    ...
                    CustomTextField(
                      ...
                      hintText:
                          AppLocalizations.of(context)!.siblingsandhisrank,
                      keyboardType: TextInputType.name,
