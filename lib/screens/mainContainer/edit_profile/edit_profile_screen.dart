              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> streamSnapshot) {
                if (streamSnapshot.hasData) {
                  ...
                  if (_bloc.openPageForTheFirstTime) {
                    ...
                    _bloc.usedLanguageValue.value = documentSnapshot[
                        "Used language with the client at home"];
                    ...
                    _bloc.kinshipValue.value = documentSnapshot[
                        "Is there any kinship between parents?"];
                    ...
                    _bloc.therapeuticName =
                        documentSnapshot["Therapeutic Name"];
